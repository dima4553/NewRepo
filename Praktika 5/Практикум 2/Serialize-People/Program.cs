...
namespace Serialize_People
{
    ...
    class Program
    {
        ...
        private static void Serialize(Person sp)
        {
            ...
            // Создаём объект XmlSerializer для выполнения сериализации
        ...
        private static Person Deserialize()
        {
            ...
            // Создаём объект XmlSerializer для выполнения десериализации
            XmlSerializer xs = new XmlSerializer(typeof(Person));

            // Используем объект XmlSerializier для десериализации данных в файл
